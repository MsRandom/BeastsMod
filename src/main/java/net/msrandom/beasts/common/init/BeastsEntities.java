...
public class BeastsEntities {
    ...
    public static final EntityType<EntityVileEel> VILE_EEL = create(EntityVileEel::new, EntityVileEel.class, EnumCreatureType.AMBIENT, 1.5F, 1.8F, 0x313337, 0x987CAF, new SpawnEntry(20, 1, 1, BeastsBiomes.THE_ABYSS));
    ...
    public static final EntityType<EntityFireflySquid> FIREFLY_SQUID = create(EntityFireflySquid::new, EntityFireflySquid.class, EnumCreatureType.CREATURE, 0.5f, 0.5f, 0x411A43, 0x50A870, new SpawnEntry(20, 2, 4, BeastsBiomes.THE_ABYSS));
    public static final EntityType<EntityTupala> TUPALA = create(EntityTupala::new, EntityTupala.class, EnumCreatureType.AMBIENT, 0.3F, 0.3F, 0xCFDBE4, 0x772D2C, new SpawnEntry(20, 2, 4, BeastsBiomes.THE_ABYSS));
    ...
    public static class EntityType<T extends Entity> {
        ...
        public EntityType(EntityEntryBuilder<T> base, Class<T> cls, EnumCreatureType classification, Function<World, T> factory) {
            base.entity(cls).factory(factory);
            this.base = base;
            this.cls = cls;
