package net.msrandom.beasts.common.item.crafting;
...
import net.msrandom.beasts.common.event.CommonEvents;
import net.msrandom.beasts.common.init.BeastsItems;
import net.msrandom.beasts.common.init.BeastsRecipes;
...
public class RecipeCoconutJuice extends ShapelessRecipes {
     ...
     *
     * @see CommonEvents#craftItem(PlayerEvent.ItemCraftedEvent) for the current logic
     */
