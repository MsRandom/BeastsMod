...
import net.msrandom.beasts.client.model.ModelAbyssalLegfish;
import net.msrandom.beasts.client.renderer.entity.layers.LayerAbyssalLegfishSpots;
import net.msrandom.beasts.common.entity.passive.EntityAbyssalLegfish;
import net.msrandom.beasts.common.entity.passive.EntityLegfish;
