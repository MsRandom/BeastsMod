...
import net.msrandom.beasts.client.model.ModelAnglerQueen;
import net.msrandom.beasts.client.renderer.entity.layers.LayerAnglerQueenGlow;
import net.msrandom.beasts.common.entity.monster.EntityAnglerQueen;
