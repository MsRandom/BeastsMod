...
public class ModelVileEel extends ModelBase {
    ...
    public ModelVileEel() {
        ...
        this.armLeft = new ModelRenderer(this, 0, 34);
        ...
        this.tailFin = new ModelRenderer(this, 31, 30);
        ...
        this.tailBase = new ModelRenderer(this, 48, 45);
        ...
        this.tailTip = new ModelRenderer(this, 0, 75);
        ...
        this.tail = new ModelRenderer(this, 30, 67);
