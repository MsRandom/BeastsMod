...
public class BeastsEntities {
    ...
    public static final EntityType<EntityVileEel> VILE_EEL = create(EntityVileEel::new, EntityVileEel.class, EnumCreatureType.AMBIENT, 1.5F, 1.8F, 0x313337, 0x987CAF, new SpawnEntry(20, 1, 1, BeastsBiomes.DRIED_REEF));
