...
public class ModelPufferFishDog extends EntityModel<EntityPufferfishDog> {
    ...
    public RendererModel collarInflated;
    public RendererModel glasses;
    ...
    public ModelPufferFishDog() {
        ...
        this.tail_1 = new RendererModel(this, 0, 12);
        ...
        this.leftArm_1 = new RendererModel(this, 17, 0);
        ...
        this.spikes = new RendererModel(this, 0, 50);
        ...
        this.leftLeg_1 = new RendererModel(this, 33, 0);
        ...
        this.body = new RendererModel(this, 16, 8);
        ...
        this.spikes_2 = new RendererModel(this, 3, 28);
        ...
        this.rightArm = new RendererModel(this, 17, 0);
        ...
        this.rightLeg_1 = new RendererModel(this, 41, 0);
        ...
        this.spikes_3 = new RendererModel(this, 0, 52);
        ...
        this.teeth_1 = new RendererModel(this, 0, 13);
        ...
        this.teeth_2 = new RendererModel(this, 0, 13);
        ...
        this.rightArm_1 = new RendererModel(this, 25, 0);
        ...
        this.spikes_1 = new RendererModel(this, 0, 28);
        ...
        this.spikes_7 = new RendererModel(this, 0, 24);
        ...
        this.tail = new RendererModel(this, 4, 37);
        ...
        this.spikes_4 = new RendererModel(this, 0, 21);
        ...
        this.collarNormal = new RendererModel(this, 14, 14);
        ...
        this.spikes_5 = new RendererModel(this, 0, 0);
    ...
    @Override
    public void render(EntityPufferfishDog entity, float f, float f1, float f2, float f3, float f4, float f5) {
        if (this.isChild) {
    ...
    @Override
    public void setRotationAngles(EntityPufferfishDog entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor) {
    ...
    @Override
    public void setLivingAnimations(EntityPufferfishDog entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTickTime) {
